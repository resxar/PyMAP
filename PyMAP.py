...
def pertama():
	...
	pilihan = raw_input("\t[1] Scan a single IP\n\t[2] Scan specific IPs\n\t[3] Scan a range\n\t[4] Scan a domain\n\t[5] Scan using CIDR notation\n\t[6] Back\n\n\t[+] Enter The Number :  ")
	if pilihan == "1":
		print ""
...
def kedua():
	...
	pilihan = raw_input("\t[1] TCP SYN Port Scan\n\t[2] TCP Connect Port Scan\n\t[3] UDP Port Scan\n\t[4] TCP ACK Port Scan\n\t[5] Back\n\n\t[+] Enter The Number : ")
	if pilihan == "1":
		print ""
